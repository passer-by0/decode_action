//Sat Jun 29 2024 13:40:51 GMT+0000 (Coordinated Universal Time)
...
class UserInfo {
  ...
  async refresh_cookie() {
    try {
      ...
      let _0x3f5a16 = await this.fetch(_0x55e5d3),
  ...
  async memberDay_lottery() {
    try {
      ...
      if (_0x47164f?.["success"]) {
        ...
        $.log("[" + (this.userName || this.index) + "][INFO] 会员日抽奖: " + productName, _0x574c0e);
      } else {
...
async function getCookie() {
  try {
    ...
    const _0x426ee9 = userCookie.findIndex(_0x5375a2 => _0x5375a2.userId == _0x35ac63.userId);
    userCookie[_0x426ee9] ? userCookie[_0x426ee9] = _0x35ac63 : userCookie.push(_0x35ac63);
    $.setjson(userCookie, ckName);
    $.msg($.name, "🎉账号[" + _0x35ac63.userName + "]更新token成功!", "");
  } catch (_0x3ade75) {
    throw _0x3ade75;
  }
}
